...
class ScanInOutLogModel {
  int? id;
  ScanInOutId? scanInOutId;
  CreatorModel? creatorId;
  int? status;
  int? del;
  String? createdAt;
  String? updatedAt;
  ...
  ScanInOutLogModel.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    scanInOutId = json['scan_in_out_id'] != null
        ? ScanInOutId.fromJson(json['scan_in_out_id'])
        : null;
    creatorId = json['creator_id'] != null
        ? CreatorModel.fromJson(json['creator_id'])
        : null;
    status = json['status'];
    del = json['del'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['id'] = id;
    if (scanInOutId != null) {
      data['scan_in_out_id'] = scanInOutId!.toJson();
    }
    if (creatorId != null) {
      data['creator_id'] = creatorId!.toJson();
    }
    data['status'] = status;
    data['del'] = del;
...
class ScanInOutId {
  ...
  ScanInOutId.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    code = json['code'];
