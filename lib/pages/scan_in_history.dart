...
class ScanInHistory extends StatefulWidget {
  const ScanInHistory({super.key});

  @override
  State<ScanInHistory> createState() => _ScanInHistoryState();
}

class _ScanInHistoryState extends State<ScanInHistory> {
  ScanHistoryState scanHistoryState = Get.put(ScanHistoryState());
  AppColors appColors = AppColors();
  TextEditingController searchT = TextEditingController();
  @override
  void initState() {
    scanHistoryState.getData(null);
    super.initState();
  }
            ...
            children: [
              Row(
               ...
               Row(
                    children: [
                      CustomText(
                        text: ' ລວມທັງໝົດ ${scan.searchList.length} ລາຍການ',
