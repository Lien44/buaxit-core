...
import 'package:bauxite_admin_app/pages/add_mineral.dart';
...
import '../customs/drop_down_widget.dart';
          ...
          GestureDetector(
            onTap: () async {
              ...
              var result = await CustomDialogs().yesAndNoDialogWithText(
                  context, fixSize, "ຕ້ອງການສະແກນອອກ ຫຼື ບໍ່");
              if (result) {
                try {
                  await cameraScanPageState
                    ...
                    if (res.statusCode == 200) {
                      ...
                      Get.to(() => const WaitingScanOutPage());
                    } else {
                      throw res.body;
                    }
                  });
