...
class SelectScanOut extends StatefulWidget {
  const SelectScanOut({super.key, required this.title});

  final String title;

  @override
  State<SelectScanOut> createState() => _SelectScanOutState();
}

class _SelectScanOutState extends State<SelectScanOut> {
  final AppColors appColors = AppColors();
  TextEditingController searchT = TextEditingController();
  CarState carState = Get.put(CarState());
  SearchScanOut searchScanOut = Get.put(SearchScanOut());
  @override
  void initState() {
    super.initState();
  }
            ...
            children: [
              Expanded(
                child: TextFieldWidget(
                  ...
                  hintText: 'search',
                  onChange: (v) async {
                    await searchScanOut.searchscanoutCar(context, v);
                  },
                ),
              ),
              const SizedBox(
